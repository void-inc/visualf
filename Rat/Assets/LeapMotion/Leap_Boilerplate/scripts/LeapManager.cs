...
public class LeapManager : MonoBehaviour {
	...
	private Vector2 _pointerPositionScreen = new Vector2(0,0);
	private Vector3 _pointerPositionWorld = new Vector2(0,0);
	private Vector3 _pointerPositionScreenToWorld = new Vector2(0,0);
